 ...
 const routes = [
      {
          path: '/studentInfo',
          name: 'studentInfo',
          component: 'studentInfo.vue',
          meta:{  isShow:true,title:'个人信息'}
      }, {
          path: '/reportForm',
          name: 'reportForm',
          component: 'reportForm.vue',
          meta:{  isShow:true,title:'报表填写'}
      }, {
          path: '/backSchoolForm',
          name: 'backSchoolForm',
          component: 'backSchoolForm.vue',
          meta:{  isShow:true,title:'返校信息'}
      },{
        path: '/afterSchoolForm',
        name: 'afterSchoolForm',
        component: 'afterSchoolForm.vue',
        meta:{  isShow:true,title:'校后管理'}
    }
  ]
