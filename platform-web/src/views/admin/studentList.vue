<template>
    <div>
      ...
      <a-table :columns="columns" :data-source="studentList" :pagination="false" bordered>
      ...
      <a-modal v-model:visible="addVisible" title="添加学生" @ok="addOk" cancelText="取消" okText="确定添加">
        <a-form :model="addStudentInfo" :label-col="labelCol" :wrapper-col="wrapperCol">
      ...
      <a-modal v-model:visible="changeVisible" title="修改信息" @ok="changeOk" cancelText="取消" okText="确定修改">
        <a-form :model="changeStudentInfos" :label-col="labelCol" :wrapper-col="wrapperCol">
          <a-form-item label="姓名">
          ...
          <a-form-item label="寝室号">
            <a-input v-model:value="changeStudentInfos.dormNumber" type="textarea" />
          </a-form-item>
          <a-form-item label="用户名">
            <a-input v-model:value="changeStudentInfos.userName" type="textarea" disabled/>
          </a-form-item>
          <a-form-item label="密码">
            <a-input v-model:value="changeStudentInfos.password" type="textarea" />
          </a-form-item>
  ...
  import { changeStudentInfo, addStudent, deleteStudent } from '../../api/student'
  ...
  const changeOk = () => {
    console.log(changeStudentInfos)
